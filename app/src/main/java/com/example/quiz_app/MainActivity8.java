...
ImageButton nxt6,pr6;
    RadioButton o1,o2,o3,o4;
    public static int marks = MainActivity7.marks;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nxt6=(ImageButton) findViewById(R.id.next6);
        pr6=findViewById(R.id.pre6);
        ...
        nxt6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!o1.isChecked() && !o2.isChecked() && !o3.isChecked() && !o4.isChecked()) {
                    Toast.makeText(MainActivity8.this, "Please Select the Answer...!", Toast.LENGTH_LONG).show();
                } else {
                    Intent Int = new Intent(MainActivity8.this, MainActivity9.class);
        ...
        pr6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in=new Intent(MainActivity8.this,MainActivity7.class);
                startActivity(in);
            }
        });
    }
